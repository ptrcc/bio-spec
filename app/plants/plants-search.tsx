    ...
    return (
        <div>
            ...
            <ul className="mt-4 flex w-full gap-2">
                <li>
                    <input type="radio" id="scientific_name" name="hosting" value="hosting-small" className="hidden peer" checked={queryType == "scientific_name"}/>
                ...
                <li>
                    <input type="radio" id="family" name="hosting" value="hosting-big" className="hidden peer" checked={queryType == "family_name"}/>
                ...
                <li>
                    <input type="radio" id="genus" name="hosting" value="hosting-big" className="hidden peer" checked={queryType == "genus_name"}/>
